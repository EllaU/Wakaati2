...
const App = ({navigation}) => {
    ...
    return (
       ...
       <AnimatedScrollView style={styles.container}>
                ...
                locations={[0.25,0.30,0.40]}
                colors={['black',  '#76045B','black']}
                ...
                <Feather
                  ...
                  <FlatList
                    ...
                    <View style={{
                     ...
                     :
                       ...
                       onPress={() => selectItem(item)}
                       >
                        <Text style={{fontSize:11,color:'lightgrey',fontFamily:'Prompt-Regular'}}>{item.title}</Text>
                  ...
                  <View style={{
                      ...
                      marginLeft:'3%'
                        ...
                        <Text style={{fontSize:14,color:'#ffff',fontFamily:'Prompt-Regular',marginLeft:'3%',marginBottom:'5%'}}>Wakaati Originals</Text>
                  ...
                  <View style={{
                    ...
                    <View style={{
                      ...
                      <Text style={{fontSize:14,color:'#ffff',fontFamily:'Prompt-Regular',marginLeft:'2%'}}>Series</Text>
                  ...
                  <View style={{
                      ...
                      <View style={{
                        ...
                        <Text style={{fontSize:14,color:'#ffff',fontFamily:'Prompt-Regular',marginLeft:'2%'}}>Hausa</Text>
                    ...
                    <View style={{
                      ...
                      <View style={{
                        ...
                        <Text style={{fontSize:14,color:'#ffff',fontFamily:'Prompt-Regular',marginLeft:'2%'}}>Documentary</Text>
